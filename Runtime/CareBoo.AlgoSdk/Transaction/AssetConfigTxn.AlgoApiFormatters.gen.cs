...
namespace AlgoSdk
{
    ...
    public partial struct AssetConfigTxn
    {
        ...
        public partial struct Params
        {
            ...
            private static bool @__generated__InitializeAlgoApiFormatters()
            {
                AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.AssetConfigTxn.Params>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.AssetConfigTxn.Params>(false).Assign("asset-id", "xaid", (AlgoSdk.AssetConfigTxn.Params x) => x.ConfigAsset, (ref AlgoSdk.AssetConfigTxn.Params x, AlgoSdk.AssetIndex value) => x.ConfigAsset = value, false).Assign("params", "params", (AlgoSdk.AssetConfigTxn.Params x) => x.AssetParams, (ref AlgoSdk.AssetConfigTxn.Params x, AlgoSdk.AssetParams value) => x.AssetParams = value, false));
                return true;
            }
        }
    }
