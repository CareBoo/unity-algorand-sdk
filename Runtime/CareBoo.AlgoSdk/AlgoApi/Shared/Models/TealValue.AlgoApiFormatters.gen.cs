...
namespace AlgoSdk
{
    ...
    public partial struct TealValue
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            ...
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.TealValueType[]>(AlgoSdk.Formatters.ArrayFormatter<AlgoSdk.TealValueType>.Instance);
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.TealValue[]>(AlgoSdk.Formatters.ArrayFormatter<AlgoSdk.TealValue>.Instance);
            return true;
        }
    }
}
namespace AlgoSdk
{
    ...
    public partial struct TealBytes
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            ...
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.TealBytes[]>(AlgoSdk.Formatters.ArrayFormatter<AlgoSdk.TealBytes>.Instance);
            return true;
        }
    }
}
