...
namespace AlgoSdk.Algod
{
    ...
    public partial struct TealValue
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.TealValue>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.TealValue>(false).Assign("type", (AlgoSdk.Algod.TealValue x) => x.Type, (ref AlgoSdk.Algod.TealValue x, System.UInt64 value) => x.Type = value).Assign("bytes", (AlgoSdk.Algod.TealValue x) => x.Bytes, (ref AlgoSdk.Algod.TealValue x, System.String value) => x.Bytes = value, AlgoSdk.StringComparer.Instance).Assign("uint", (AlgoSdk.Algod.TealValue x) => x.Uint, (ref AlgoSdk.Algod.TealValue x, System.UInt64 value) => x.Uint = value));
            return true;
        }
    }
}
namespace AlgoSdk.Algod
{
    ...
    public partial struct ParticipationKey
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.ParticipationKey>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.ParticipationKey>(false).Assign("id", (AlgoSdk.Algod.ParticipationKey x) => x.Id, (ref AlgoSdk.Algod.ParticipationKey x, System.String value) => x.Id = value, AlgoSdk.StringComparer.Instance).Assign("address", (AlgoSdk.Algod.ParticipationKey x) => x.Address, (ref AlgoSdk.Algod.ParticipationKey x, AlgoSdk.Address value) => x.Address = value).Assign("effective-first-valid", (AlgoSdk.Algod.ParticipationKey x) => x.EffectiveFirstValid, (ref AlgoSdk.Algod.ParticipationKey x, AlgoSdk.Optional<System.UInt64> value) => x.EffectiveFirstValid = value).Assign("effective-last-valid", (AlgoSdk.Algod.ParticipationKey x) => x.EffectiveLastValid, (ref AlgoSdk.Algod.ParticipationKey x, AlgoSdk.Optional<System.UInt64> value) => x.EffectiveLastValid = value).Assign("last-vote", (AlgoSdk.Algod.ParticipationKey x) => x.LastVote, (ref AlgoSdk.Algod.ParticipationKey x, AlgoSdk.Optional<System.UInt64> value) => x.LastVote = value).Assign("last-block-proposal", (AlgoSdk.Algod.ParticipationKey x) => x.LastBlockProposal, (ref AlgoSdk.Algod.ParticipationKey x, AlgoSdk.Optional<System.UInt64> value) => x.LastBlockProposal = value).Assign("last-state-proof", (AlgoSdk.Algod.ParticipationKey x) => x.LastStateProof, (ref AlgoSdk.Algod.ParticipationKey x, AlgoSdk.Optional<System.UInt64> value) => x.LastStateProof = value).Assign("key", (AlgoSdk.Algod.ParticipationKey x) => x.Key, (ref AlgoSdk.Algod.ParticipationKey x, AlgoSdk.Algod.AccountParticipation value) => x.Key = value));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct DryrunState
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.DryrunState>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.DryrunState>(false).Assign("line", (AlgoSdk.Algod.DryrunState x) => x.Line, (ref AlgoSdk.Algod.DryrunState x, System.UInt64 value) => x.Line = value).Assign("pc", (AlgoSdk.Algod.DryrunState x) => x.Pc, (ref AlgoSdk.Algod.DryrunState x, System.UInt64 value) => x.Pc = value).Assign("stack", (AlgoSdk.Algod.DryrunState x) => x.Stack, (ref AlgoSdk.Algod.DryrunState x, AlgoSdk.Algod.TealValue[] value) => x.Stack = value, AlgoSdk.ArrayComparer<AlgoSdk.Algod.TealValue>.Instance).Assign("scratch", (AlgoSdk.Algod.DryrunState x) => x.Scratch, (ref AlgoSdk.Algod.DryrunState x, AlgoSdk.Algod.TealValue[] value) => x.Scratch = value, AlgoSdk.ArrayComparer<AlgoSdk.Algod.TealValue>.Instance).Assign("error", (AlgoSdk.Algod.DryrunState x) => x.Error, (ref AlgoSdk.Algod.DryrunState x, System.String value) => x.Error = value, AlgoSdk.StringComparer.Instance));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct PendingTransactionResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.PendingTransactionResponse>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.PendingTransactionResponse>(false).Assign("pool-error", (AlgoSdk.Algod.PendingTransactionResponse x) => x.PoolError, (ref AlgoSdk.Algod.PendingTransactionResponse x, System.String value) => x.PoolError = value, AlgoSdk.StringComparer.Instance).Assign("logs", (AlgoSdk.Algod.PendingTransactionResponse x) => x.Logs, (ref AlgoSdk.Algod.PendingTransactionResponse x, System.Byte[][] value) => x.Logs = value, AlgoSdk.ArrayComparer<System.Byte[], AlgoSdk.ArrayComparer<System.Byte>>.Instance).Assign("sender-rewards", (AlgoSdk.Algod.PendingTransactionResponse x) => x.SenderRewards, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.SenderRewards = value).Assign("closing-amount", (AlgoSdk.Algod.PendingTransactionResponse x) => x.ClosingAmount, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.ClosingAmount = value).Assign("txn", (AlgoSdk.Algod.PendingTransactionResponse x) => x.Txn, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.SignedTxn value) => x.Txn = value).Assign("global-state-delta", (AlgoSdk.Algod.PendingTransactionResponse x) => x.GlobalStateDelta, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Algod.StateDelta value) => x.GlobalStateDelta = value).Assign("asset-closing-amount", (AlgoSdk.Algod.PendingTransactionResponse x) => x.AssetClosingAmount, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.AssetClosingAmount = value).Assign("confirmed-round", (AlgoSdk.Algod.PendingTransactionResponse x) => x.ConfirmedRound, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.ConfirmedRound = value).Assign("application-index", (AlgoSdk.Algod.PendingTransactionResponse x) => x.ApplicationIndex, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.ApplicationIndex = value).Assign("receiver-rewards", (AlgoSdk.Algod.PendingTransactionResponse x) => x.ReceiverRewards, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.ReceiverRewards = value).Assign("inner-txns", (AlgoSdk.Algod.PendingTransactionResponse x) => x.InnerTxns, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Algod.PendingTransactionResponse[] value) => x.InnerTxns = value, AlgoSdk.ArrayComparer<AlgoSdk.Algod.PendingTransactionResponse>.Instance).Assign("asset-index", (AlgoSdk.Algod.PendingTransactionResponse x) => x.AssetIndex, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.AssetIndex = value).Assign("close-rewards", (AlgoSdk.Algod.PendingTransactionResponse x) => x.CloseRewards, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Optional<System.UInt64> value) => x.CloseRewards = value).Assign("local-state-delta", (AlgoSdk.Algod.PendingTransactionResponse x) => x.LocalStateDelta, (ref AlgoSdk.Algod.PendingTransactionResponse x, AlgoSdk.Algod.AccountStateDelta[] value) => x.LocalStateDelta = value, AlgoSdk.ArrayComparer<AlgoSdk.Algod.AccountStateDelta>.Instance));
            return true;
        }
    }
}
namespace AlgoSdk.Algod
{
    ...
    public partial struct DryrunSource
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.DryrunSource>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.DryrunSource>(false).Assign("field-name", (AlgoSdk.Algod.DryrunSource x) => x.FieldName, (ref AlgoSdk.Algod.DryrunSource x, System.String value) => x.FieldName = value, AlgoSdk.StringComparer.Instance).Assign("source", (AlgoSdk.Algod.DryrunSource x) => x.Source, (ref AlgoSdk.Algod.DryrunSource x, System.String value) => x.Source = value, AlgoSdk.StringComparer.Instance).Assign("txn-index", (AlgoSdk.Algod.DryrunSource x) => x.TxnIndex, (ref AlgoSdk.Algod.DryrunSource x, System.UInt64 value) => x.TxnIndex = value).Assign("app-index", (AlgoSdk.Algod.DryrunSource x) => x.AppIndex, (ref AlgoSdk.Algod.DryrunSource x, System.UInt64 value) => x.AppIndex = value));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct AccountParticipation
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.AccountParticipation>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.AccountParticipation>(false).Assign("selection-participation-key", (AlgoSdk.Algod.AccountParticipation x) => x.SelectionParticipationKey, (ref AlgoSdk.Algod.AccountParticipation x, System.Byte[] value) => x.SelectionParticipationKey = value, AlgoSdk.ArrayComparer<System.Byte>.Instance).Assign("vote-first-valid", (AlgoSdk.Algod.AccountParticipation x) => x.VoteFirstValid, (ref AlgoSdk.Algod.AccountParticipation x, System.UInt64 value) => x.VoteFirstValid = value).Assign("vote-key-dilution", (AlgoSdk.Algod.AccountParticipation x) => x.VoteKeyDilution, (ref AlgoSdk.Algod.AccountParticipation x, System.UInt64 value) => x.VoteKeyDilution = value).Assign("vote-last-valid", (AlgoSdk.Algod.AccountParticipation x) => x.VoteLastValid, (ref AlgoSdk.Algod.AccountParticipation x, System.UInt64 value) => x.VoteLastValid = value).Assign("vote-participation-key", (AlgoSdk.Algod.AccountParticipation x) => x.VoteParticipationKey, (ref AlgoSdk.Algod.AccountParticipation x, System.Byte[] value) => x.VoteParticipationKey = value, AlgoSdk.ArrayComparer<System.Byte>.Instance).Assign("state-proof-key", (AlgoSdk.Algod.AccountParticipation x) => x.StateProofKey, (ref AlgoSdk.Algod.AccountParticipation x, System.Byte[] value) => x.StateProofKey = value, AlgoSdk.ArrayComparer<System.Byte>.Instance));
            return true;
        }
    }
}
namespace AlgoSdk.Algod
{
    ...
    public partial struct Version
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.Version>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.Version>(false).Assign("build", (AlgoSdk.Algod.Version x) => x.Build, (ref AlgoSdk.Algod.Version x, AlgoSdk.Algod.BuildVersion value) => x.Build = value).Assign("genesis_hash_b64", (AlgoSdk.Algod.Version x) => x.Genesis_hash_b64, (ref AlgoSdk.Algod.Version x, System.Byte[] value) => x.Genesis_hash_b64 = value, AlgoSdk.ArrayComparer<System.Byte>.Instance).Assign("genesis_id", (AlgoSdk.Algod.Version x) => x.Genesis_id, (ref AlgoSdk.Algod.Version x, System.String value) => x.Genesis_id = value, AlgoSdk.StringComparer.Instance).Assign("versions", (AlgoSdk.Algod.Version x) => x.Versions, (ref AlgoSdk.Algod.Version x, System.String[] value) => x.Versions = value, AlgoSdk.ArrayComparer<System.String, AlgoSdk.StringComparer>.Instance));
            return true;
        }
    }
}
namespace AlgoSdk.Algod
{
    ...
    public partial struct AssetParams
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.AssetParams>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.AssetParams>(false).Assign("default-frozen", (AlgoSdk.Algod.AssetParams x) => x.DefaultFrozen, (ref AlgoSdk.Algod.AssetParams x, AlgoSdk.Optional<System.Boolean> value) => x.DefaultFrozen = value).Assign("creator", (AlgoSdk.Algod.AssetParams x) => x.Creator, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.Creator = value, AlgoSdk.StringComparer.Instance).Assign("decimals", (AlgoSdk.Algod.AssetParams x) => x.Decimals, (ref AlgoSdk.Algod.AssetParams x, System.UInt64 value) => x.Decimals = value).Assign("freeze", (AlgoSdk.Algod.AssetParams x) => x.Freeze, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.Freeze = value, AlgoSdk.StringComparer.Instance).Assign("reserve", (AlgoSdk.Algod.AssetParams x) => x.Reserve, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.Reserve = value, AlgoSdk.StringComparer.Instance).Assign("unit-name-b64", (AlgoSdk.Algod.AssetParams x) => x.UnitNameB64, (ref AlgoSdk.Algod.AssetParams x, System.Byte[] value) => x.UnitNameB64 = value, AlgoSdk.ArrayComparer<System.Byte>.Instance).Assign("name", (AlgoSdk.Algod.AssetParams x) => x.Name, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.Name = value, AlgoSdk.StringComparer.Instance).Assign("url-b64", (AlgoSdk.Algod.AssetParams x) => x.UrlB64, (ref AlgoSdk.Algod.AssetParams x, System.Byte[] value) => x.UrlB64 = value, AlgoSdk.ArrayComparer<System.Byte>.Instance).Assign("total", (AlgoSdk.Algod.AssetParams x) => x.Total, (ref AlgoSdk.Algod.AssetParams x, System.UInt64 value) => x.Total = value).Assign("manager", (AlgoSdk.Algod.AssetParams x) => x.Manager, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.Manager = value, AlgoSdk.StringComparer.Instance).Assign("name-b64", (AlgoSdk.Algod.AssetParams x) => x.NameB64, (ref AlgoSdk.Algod.AssetParams x, System.Byte[] value) => x.NameB64 = value, AlgoSdk.ArrayComparer<System.Byte>.Instance).Assign("url", (AlgoSdk.Algod.AssetParams x) => x.Url, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.Url = value, AlgoSdk.StringComparer.Instance).Assign("unit-name", (AlgoSdk.Algod.AssetParams x) => x.UnitName, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.UnitName = value, AlgoSdk.StringComparer.Instance).Assign("clawback", (AlgoSdk.Algod.AssetParams x) => x.Clawback, (ref AlgoSdk.Algod.AssetParams x, System.String value) => x.Clawback = value, AlgoSdk.StringComparer.Instance).Assign("metadata-hash", (AlgoSdk.Algod.AssetParams x) => x.MetadataHash, (ref AlgoSdk.Algod.AssetParams x, System.Byte[] value) => x.MetadataHash = value, AlgoSdk.ArrayComparer<System.Byte>.Instance));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct AccountAssetResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.AccountAssetResponse>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.AccountAssetResponse>(false).Assign("round", (AlgoSdk.Algod.AccountAssetResponse x) => x.Round, (ref AlgoSdk.Algod.AccountAssetResponse x, System.UInt64 value) => x.Round = value).Assign("asset-holding", (AlgoSdk.Algod.AccountAssetResponse x) => x.AssetHolding, (ref AlgoSdk.Algod.AccountAssetResponse x, AlgoSdk.Algod.AssetHolding value) => x.AssetHolding = value).Assign("created-asset", (AlgoSdk.Algod.AccountAssetResponse x) => x.CreatedAsset, (ref AlgoSdk.Algod.AccountAssetResponse x, AlgoSdk.Algod.AssetParams value) => x.CreatedAsset = value));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct NodeStatusResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.NodeStatusResponse>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.NodeStatusResponse>(false).Assign("stopped-at-unsupported-round", (AlgoSdk.Algod.NodeStatusResponse x) => x.StoppedAtUnsupportedRound, (ref AlgoSdk.Algod.NodeStatusResponse x, System.Boolean value) => x.StoppedAtUnsupportedRound = value).Assign("catchpoint-total-blocks", (AlgoSdk.Algod.NodeStatusResponse x) => x.CatchpointTotalBlocks, (ref AlgoSdk.Algod.NodeStatusResponse x, AlgoSdk.Optional<System.UInt64> value) => x.CatchpointTotalBlocks = value).Assign("last-version", (AlgoSdk.Algod.NodeStatusResponse x) => x.LastVersion, (ref AlgoSdk.Algod.NodeStatusResponse x, System.String value) => x.LastVersion = value, AlgoSdk.StringComparer.Instance).Assign("next-version-round", (AlgoSdk.Algod.NodeStatusResponse x) => x.NextVersionRound, (ref AlgoSdk.Algod.NodeStatusResponse x, System.UInt64 value) => x.NextVersionRound = value).Assign("catchpoint-total-accounts", (AlgoSdk.Algod.NodeStatusResponse x) => x.CatchpointTotalAccounts, (ref AlgoSdk.Algod.NodeStatusResponse x, AlgoSdk.Optional<System.UInt64> value) => x.CatchpointTotalAccounts = value).Assign("time-since-last-round", (AlgoSdk.Algod.NodeStatusResponse x) => x.TimeSinceLastRound, (ref AlgoSdk.Algod.NodeStatusResponse x, System.UInt64 value) => x.TimeSinceLastRound = value).Assign("next-version", (AlgoSdk.Algod.NodeStatusResponse x) => x.NextVersion, (ref AlgoSdk.Algod.NodeStatusResponse x, System.String value) => x.NextVersion = value, AlgoSdk.StringComparer.Instance).Assign("catchpoint-verified-accounts", (AlgoSdk.Algod.NodeStatusResponse x) => x.CatchpointVerifiedAccounts, (ref AlgoSdk.Algod.NodeStatusResponse x, AlgoSdk.Optional<System.UInt64> value) => x.CatchpointVerifiedAccounts = value).Assign("catchup-time", (AlgoSdk.Algod.NodeStatusResponse x) => x.CatchupTime, (ref AlgoSdk.Algod.NodeStatusResponse x, System.UInt64 value) => x.CatchupTime = value).Assign("last-catchpoint", (AlgoSdk.Algod.NodeStatusResponse x) => x.LastCatchpoint, (ref AlgoSdk.Algod.NodeStatusResponse x, System.String value) => x.LastCatchpoint = value, AlgoSdk.StringComparer.Instance).Assign("last-round", (AlgoSdk.Algod.NodeStatusResponse x) => x.LastRound, (ref AlgoSdk.Algod.NodeStatusResponse x, System.UInt64 value) => x.LastRound = value).Assign("next-version-supported", (AlgoSdk.Algod.NodeStatusResponse x) => x.NextVersionSupported, (ref AlgoSdk.Algod.NodeStatusResponse x, System.Boolean value) => x.NextVersionSupported = value).Assign("catchpoint", (AlgoSdk.Algod.NodeStatusResponse x) => x.Catchpoint, (ref AlgoSdk.Algod.NodeStatusResponse x, System.String value) => x.Catchpoint = value, AlgoSdk.StringComparer.Instance).Assign("catchpoint-acquired-blocks", (AlgoSdk.Algod.NodeStatusResponse x) => x.CatchpointAcquiredBlocks, (ref AlgoSdk.Algod.NodeStatusResponse x, AlgoSdk.Optional<System.UInt64> value) => x.CatchpointAcquiredBlocks = value).Assign("catchpoint-processed-accounts", (AlgoSdk.Algod.NodeStatusResponse x) => x.CatchpointProcessedAccounts, (ref AlgoSdk.Algod.NodeStatusResponse x, AlgoSdk.Optional<System.UInt64> value) => x.CatchpointProcessedAccounts = value));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct AccountApplicationResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.AccountApplicationResponse>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.AccountApplicationResponse>(false).Assign("round", (AlgoSdk.Algod.AccountApplicationResponse x) => x.Round, (ref AlgoSdk.Algod.AccountApplicationResponse x, System.UInt64 value) => x.Round = value).Assign("app-local-state", (AlgoSdk.Algod.AccountApplicationResponse x) => x.AppLocalState, (ref AlgoSdk.Algod.AccountApplicationResponse x, AlgoSdk.Algod.ApplicationLocalState value) => x.AppLocalState = value).Assign("created-app", (AlgoSdk.Algod.AccountApplicationResponse x) => x.CreatedApp, (ref AlgoSdk.Algod.AccountApplicationResponse x, AlgoSdk.Algod.ApplicationParams value) => x.CreatedApp = value));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct DryrunResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.DryrunResponse>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Algod.DryrunResponse>(false).Assign("txns", (AlgoSdk.Algod.DryrunResponse x) => x.Txns, (ref AlgoSdk.Algod.DryrunResponse x, AlgoSdk.Algod.DryrunTxnResult[] value) => x.Txns = value, AlgoSdk.ArrayComparer<AlgoSdk.Algod.DryrunTxnResult>.Instance).Assign("error", (AlgoSdk.Algod.DryrunResponse x) => x.Error, (ref AlgoSdk.Algod.DryrunResponse x, System.String value) => x.Error = value, AlgoSdk.StringComparer.Instance).Assign("protocol-version", (AlgoSdk.Algod.DryrunResponse x) => x.ProtocolVersion, (ref AlgoSdk.Algod.DryrunResponse x, System.String value) => x.ProtocolVersion = value, AlgoSdk.StringComparer.Instance));
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct ApplicationResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.ApplicationResponse>(new AlgoSdk.WrappedValueFormatter<AlgoSdk.Algod.ApplicationResponse, AlgoSdk.Algod.Application>());
            return true;
        }
    }
}
namespace AlgoSdk.Algod
{
    ...
    public partial struct AssetResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.AssetResponse>(new AlgoSdk.WrappedValueFormatter<AlgoSdk.Algod.AssetResponse, AlgoSdk.Algod.Asset>());
            return true;
        }
    }
}
...
namespace AlgoSdk.Algod
{
    ...
    public partial struct VersionsResponse
    {
        ...
        private static bool @__generated__InitializeAlgoApiFormatters()
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Algod.VersionsResponse>(new AlgoSdk.WrappedValueFormatter<AlgoSdk.Algod.VersionsResponse, AlgoSdk.Algod.Version>());
            return true;
        }
    }
}
