...
namespace AlgoSdk.Abi
{
    ...
    public partial struct Method
    {
        ...
        public partial struct Arg
        {
            ...
            private static bool @__generated__InitializeAlgoApiFormatters()
            {
                AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Abi.Method.Arg>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Abi.Method.Arg>(false).Assign("type", (AlgoSdk.Abi.Method.Arg x) => x.Type, (ref AlgoSdk.Abi.Method.Arg x, AlgoSdk.Abi.IAbiType value) => x.Type = value, AlgoSdk.IAbiTypeComparer.Instance).Assign("name", (AlgoSdk.Abi.Method.Arg x) => x.Name, (ref AlgoSdk.Abi.Method.Arg x, System.String value) => x.Name = value, AlgoSdk.StringComparer.Instance).Assign("desc", (AlgoSdk.Abi.Method.Arg x) => x.Description, (ref AlgoSdk.Abi.Method.Arg x, System.String value) => x.Description = value, AlgoSdk.StringComparer.Instance));
                return true;
            }
        }
        ...
        public partial struct Return
        {
            ...
            private static bool @__generated__InitializeAlgoApiFormatters()
            {
                AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.Abi.Method.Return>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.Abi.Method.Return>(false).Assign("type", (AlgoSdk.Abi.Method.Return x) => x.Type, (ref AlgoSdk.Abi.Method.Return x, AlgoSdk.Abi.IAbiType value) => x.Type = value, AlgoSdk.IAbiTypeComparer.Instance).Assign("desc", (AlgoSdk.Abi.Method.Return x) => x.Description, (ref AlgoSdk.Abi.Method.Return x, System.String value) => x.Description = value, AlgoSdk.StringComparer.Instance));
                return true;
            }
        }
    }
