...
namespace AlgoSdk.WalletConnect
{
    ...
    public partial struct WalletConnectSessionData
    {
        ...
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.WalletConnect.WalletConnectSessionData>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.WalletConnect.WalletConnectSessionData>(false).Assign("peerId", (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.PeerId, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, System.String value) => x.PeerId = value, AlgoSdk.StringComparer.Instance).Assign("peerMeta", (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.PeerMeta, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, AlgoSdk.WalletConnect.ClientMeta value) => x.PeerMeta = value).Assign("approved", (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.IsApproved, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, System.Boolean value) => x.IsApproved = value).Assign("chainId", (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.ChainId, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, System.Int32 value) => x.ChainId = value).Assign("accounts", (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.Accounts, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, AlgoSdk.Address[] value) => x.Accounts = value, AlgoSdk.ArrayComparer<AlgoSdk.Address>.Instance));
            return true;
        }
    }
}
