...
namespace Algorand.Unity
{
    ...
    public partial struct BlockCertificate
    {
        ...
        {
            Algorand.Unity.AlgoApiFormatterLookup.Add<Algorand.Unity.BlockCertificate>(new Algorand.Unity.AlgoApiObjectFormatter<Algorand.Unity.BlockCertificate>(false));
            return true;
        }
    }
}
