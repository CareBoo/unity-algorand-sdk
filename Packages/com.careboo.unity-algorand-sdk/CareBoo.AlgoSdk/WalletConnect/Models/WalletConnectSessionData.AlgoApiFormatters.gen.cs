...
namespace AlgoSdk.WalletConnect
{
    ...
    public partial struct WalletConnectSessionData
    {
        ...
        {
            AlgoSdk.AlgoApiFormatterLookup.AddFormatter(typeof(AlgoSdk.WalletConnect.WalletConnectSessionData), new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.WalletConnect.WalletConnectSessionData>().Assign("peerId", null, (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.PeerId, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, System.String value) => x.PeerId = value, AlgoSdk.StringComparer.Instance, false).Assign("peerMeta", null, (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.PeerMeta, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, AlgoSdk.WalletConnect.ClientMeta value) => x.PeerMeta = value, false).Assign("approved", null, (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.IsApproved, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, System.Boolean value) => x.IsApproved = value, false).Assign("chainId", null, (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.ChainId, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, System.Int32 value) => x.ChainId = value, false).Assign("accounts", null, (AlgoSdk.WalletConnect.WalletConnectSessionData x) => x.Accounts, (ref AlgoSdk.WalletConnect.WalletConnectSessionData x, AlgoSdk.Address[] value) => x.Accounts = value, AlgoSdk.ArrayComparer<AlgoSdk.Address>.Instance, false));
            AlgoSdk.AlgoApiFormatterLookup.AddFormatter(typeof(AlgoSdk.WalletConnect.WalletConnectSessionData[]), AlgoSdk.Formatters.ArrayFormatter<AlgoSdk.WalletConnect.WalletConnectSessionData[]>.Instance);
            return true;
        }
    }
}
