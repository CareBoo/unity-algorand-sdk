...
namespace AlgoSdk.Formatters
{
        ...
        where T : Enum
    {
        ...
        private delegate void JsonSerialize(ref JsonWriter writer, T value);
        private delegate T MessagePackDeserialize(ref MessagePackReader reader);
        private delegate void MessagePackSerialize(ref MessagePackWriter writer, T value);
...
#pragma warning restore SA1107 // Avoid multiple statements on same line.
        ...
        {
            return jsonDeserialize(ref reader);
        }

        public T Deserialize(ref MessagePackReader reader)
        {
            return messagePackDeserialize(ref reader);
        }

        public void Serialize(ref JsonWriter writer, T value)
        {
            jsonSerialize(ref writer, ref value);
        }

        public void Serialize(ref MessagePackWriter writer, T value)
        {
            messagePackSerialize(ref writer, ref value);
        }
    }
}
