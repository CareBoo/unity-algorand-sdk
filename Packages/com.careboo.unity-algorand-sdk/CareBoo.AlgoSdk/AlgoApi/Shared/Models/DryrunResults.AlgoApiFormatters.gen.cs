...
namespace AlgoSdk
{
    ...
    public partial struct DryrunResults
    {
        ...
        {
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.DryrunResults>(new AlgoSdk.AlgoApiObjectFormatter<AlgoSdk.DryrunResults>().Assign("error", null, (AlgoSdk.DryrunResults x) => x.Error, (ref AlgoSdk.DryrunResults x, System.String value) => x.Error = value, AlgoSdk.StringComparer.Instance, false).Assign("protocol-version", null, (AlgoSdk.DryrunResults x) => x.ProtocolVersion, (ref AlgoSdk.DryrunResults x, Unity.Collections.FixedString128Bytes value) => x.ProtocolVersion = value, false).Assign("txns", null, (AlgoSdk.DryrunResults x) => x.Txns, (ref AlgoSdk.DryrunResults x, AlgoSdk.DryrunTxnResult[] value) => x.Txns = value, AlgoSdk.ArrayComparer<AlgoSdk.DryrunTxnResult>.Instance, false));
            AlgoSdk.AlgoApiFormatterLookup.Add<AlgoSdk.DryrunResults[]>(AlgoSdk.Formatters.ArrayFormatter<AlgoSdk.DryrunResults>.Instance);
            return true;
        }
    }
}
